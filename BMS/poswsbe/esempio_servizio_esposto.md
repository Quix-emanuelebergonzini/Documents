Url:
https://fr-ws-dev.bms.maxmara.com/bin/driver_ws
oppure
https://itmn-ws.bms.maxmara.com/bin/driver_ws

Body:
{
    "ws_req_type": "PASSWORD",
    "module": "ws_interface_store",
    "program": "ws_dematerialization_set",
    "ws_client_user": "pos-sede-be",
    "ws_client_pwd": "fipDecr53vFjh7s22",
    "ws_prints": [{
        "ref": "0901042-2022-12345-VENDITA-1",
        "path": "asd/dsa/vendita-scontrino-20221107.pdf"
    }],
    "ws_cod_negozio": "0901042",
    "ws_email": "emanuele.bergonzini@quix.it"
}
...
if (pm.request.body) {
    ...
    try {
		...
		console.log(body.ws_prints);
		body.ws_prints = JSON.stringify(body.ws_prints);
		pm.request.body.raw = JSON.stringify(body);
    } catch (e) {
		console.log(e)
    }
